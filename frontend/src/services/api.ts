...
import { User, UserRequest, Exercise, TrainingPlan, WeeklyPlan, DailyPlan, PageResponse } from '../types';
...
// Add basic auth interceptor (you can modify this based on your auth system)
