...
public class DailyExercise {
    ...
    @Column(name = "reps")
    private String reps; // e.g., "12-15", "8-10", "30 seconds"

    @Column(name = "weight")
    private String weight; // e.g., "bodyweight", "15kg", "increase by 2.5kg"

    @Column(name = "rest_time")
    private String restTime; // e.g., "60 seconds", "2 minutes"

    @Column(name = "order_in_workout")
    private Integer orderInWorkout;

    @Column(name = "notes", columnDefinition = "TEXT")
    private String notes; // Special instructions for this exercise
